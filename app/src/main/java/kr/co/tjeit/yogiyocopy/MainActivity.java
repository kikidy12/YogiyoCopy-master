...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oderListView = (ListView) findViewById(R.id.oderListView);
        ...
        storeDataList.add(new StoreData("https://www.yogiyo.co.kr/media/restaurant_logos/%EB%96%A1%EB%B3%B6%EC%9D%B4%EC%88%9C%EB%8C%80%EC%84%B8%ED%8A%B801_20131128_FoodAD_crop_200x200_yjnTv3z.jpg","스쿨스토어-종로점", 4.1f, 1200, 2120, 16000, false));
        storeDataList.add(new StoreData("https://www.yogiyo.co.kr/media/restaurant_logos/%EB%B3%B8%EB%8F%84%EC%8B%9C%EB%9D%BD_20150825_Franchise%EC%9D%B4%EB%AF%B8%EC%A7%80%EC%95%BD%EC%A0%95%EC%84%9C_crop_200x200_zY4cB53.jpg","본도시락", 3.8f, 1100, 300, 25000, false));
        storeDataList.add(new StoreData("https://www.yogiyo.co.kr/media/restaurant_logos/%ED%83%95%EC%88%98%EC%9C%A103_20131128_FoodAD_crop_200x200_Rn9zt25.jpg","탕수육", 3.8f, 1100, 300, 25000, false));
        storeDataList.add(new StoreData("https://www.yogiyo.co.kr/media/restaurant_logos/%EC%89%AC%EB%A6%BC%ED%94%84_%ED%94%BC%EC%9E%9001_20131128_FoodAD_crop_200x200.jpg","페밀리피자", 3.8f, 1100, 300, 25000, false));
        ...
        orderDataList.add(new OrderData(storeDataList.get(1), Calendar.getInstance(), "종로 5가", 20000));
        orderDataList.add(new OrderData(storeDataList.get(1), Calendar.getInstance(), "종로 1가", 35000));
        orderDataList.add(new OrderData(storeDataList.get(2), Calendar.getInstance(), "종로 1가", 35000));
        orderDataList.add(new OrderData(storeDataList.get(2), Calendar.getInstance(), "종로 1가", 35000));
        orderDataList.add(new OrderData(storeDataList.get(5), Calendar.getInstance(), "종로 1가", 35000));

        orderAdapter = new OrderAdapter(MainActivity.this, orderDataList);
        oderListView.setAdapter(orderAdapter);
